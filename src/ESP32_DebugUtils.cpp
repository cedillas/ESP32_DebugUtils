...
void ESP32_DebugUtils::setFormat(char *format) { _format = format; }

void ESP32_DebugUtils::setDebugLevel(int const debug_level) { _debug_level = debug_level; }
...
{
  _debug_output_file.close();
  _debug_output_file_enabled = false;
}

void ESP32_DebugUtils::timestampOn() { _timestamp_on = true; }

void ESP32_DebugUtils::timestampOff() { _timestamp_on = false; }

void ESP32_DebugUtils::messageTypeOn() { _messageType_on = true; }

void ESP32_DebugUtils::messageTypeOff() { _messageType_on = false; }
